...
public class SampleGenerator {
    ...
    private static final Logger  LOG                      = LoggerFactory
                                                              .getLogger(SampleGenerator.class);
    ...
    public static void generateData(String serviceUrl) {
        SampleGenerator app = new SampleGenerator();
    ...
    public void generateSampleData(String serviceUrl) {
        ...
        String serviceBla = "{\"Id\":\"1\",\"Name\":\"bla\",\"Url\":\"http://bla.com/kecks\"}";
        String serviceBlubb = "{\"Id\":\"2\",\"Name\":\"blubb\",\"Url\":\"http://blubb.net/svc\"}";
...
// ODataEntry object
    ...
    private HttpStatusCodes checkStatus(HttpURLConnection connection) throws IOException {
        HttpStatusCodes httpStatusCode = HttpStatusCodes.fromStatusCode(connection
            .getResponseCode());
